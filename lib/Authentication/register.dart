           ...
           InkWell(
             ...
             child: CircleAvatar(
               ...
               child: _imageFile == null
                   ? Icon(Icons.add_a_photo,size: _screenWidth = 0.15, color: Colors.deepPurpleAccent,)
                   : null,
             ),
           ),
           SizedBox(height: 8.0,),
   ...
   if(_imageFile= null)
   ...
   else
     {
       _passwordTextEditingController.text == _cPasswordTextEditingController.text
           ...
           : displayDialog("Please fill the form completly")
     ...
     Future saveUserInfoToFireStore(FirebaseUser fuser) async
     {
       Firestore.instance.collection("users").document(fuser.uid).setData({
         ...
         "url": userImageUrl,
         EcommerceApp.userCartList: ["gargbageValue"],
       });
       ...
       await EcommerceApp.sharedPreferences.setStringList(EcommerceApp.userCartList, ["gargbageValue"]);
